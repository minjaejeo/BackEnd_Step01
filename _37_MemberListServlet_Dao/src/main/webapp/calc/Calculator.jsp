...
<!-- page 지시자
원래 jsp를 다른 언어도 지원하려고 했으나, 워낙 기술의 빠른 발달로 다른 Web 방식도 나오니까
...
<!-- Model One 방식
	...
	-> 나중에 java 코드의 Controller는 Servlet으로, DB/Query는 java 클래스로 만들고
		jsp는 주로 View역할(html)만 담당한다.
		
	지금은 jsp를 설명하기 위해서 java 코드를 넣었다.
		...
		- 2) html과 java는 서로 다른 영역의 언어이다.
			...
			EL와 jstl은 표현식이기 때문에 간결하게 표현되어진다.
...
<!-- 스크립트릿
	...
	Service(D:\Lecture\BackEnd_Step01_min\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\work\Catalina\localhost\_22_Calculator_jsp\org\apache\jsp\calc) 함수 안에 포함된다.
 -->
<%
String v1 = "";
String v2 = "";
