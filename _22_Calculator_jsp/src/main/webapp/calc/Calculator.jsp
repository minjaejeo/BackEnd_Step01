...
<!-- Model one 방식
	...
	- 2) html과 java는 서로 다른 영역의 언어이다.
		...
		EL과 jstl은 표현식이기 떄문에 간결하게 표현되어진다.
...
// _jspService(HttpServletRequest request, HttpServletResponse response)함수 안에 포함된다.
